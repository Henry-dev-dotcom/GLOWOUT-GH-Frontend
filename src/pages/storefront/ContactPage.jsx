...
import { Card, Field, PageHero, Reveal, SelectField, Button } from '../../components/Common';
      ...
      <section className="pb-16">
        <div className="container-lux grid gap-8 lg:grid-cols-[.85fr_1.15fr]">
          <div className="grid gap-5">
            <Reveal><Card className="p-6"><h3 className="font-display text-2xl font-bold text-gold">Contact Details</h3><div className="mt-5 space-y-3 text-[#C8BAD0]"><p><strong className="text-white">Email:</strong> {settings.email}</p><p><strong className="text-white">Phone:</strong> {settings.phone}</p><p><strong className="text-white">WhatsApp:</strong> {settings.whatsapp}</p><p><strong className="text-white">Location:</strong> {settings.address}</p></div></Card></Reveal>
            <Reveal delay={80}><Card className="p-6"><h3 className="font-display text-2xl font-bold text-gold">Support Hours</h3><p className="mt-3 leading-7 text-[#8A7A98]">Monday to Saturday, 9:00am - 6:00pm. Delivery and order updates are handled during working hours.</p></Card></Reveal>
            <Reveal delay={160}><Card className="p-6"><h3 className="font-display text-2xl font-bold text-gold">Quick Help</h3><div className="mt-4 grid gap-3 text-sm text-[#C8BAD0]"><p>• Product recommendation and availability</p><p>• Delivery fee and order tracking</p><p>• Returns, exchanges and damaged items</p><p>• Wholesale or partnership requests</p></div></Card></Reveal>
          </div>
          <Reveal delay={120}>
            <Card className="p-7">
